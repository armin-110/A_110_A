...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 15 02:52:22 2019
...
for i in range(len(return_name)):
    ...
    #output_vag[i]=return_name[i][0]

#for j in range(len(return_name)):
    #try:
      #  output_vag[j]= mode(return_name[j])   
   # except: 
       # output_vag[j]=return_name[j][0]


#print(output_vag)    
#print('similarity_vec') 
#print(similarity_vec[627])    
#print(input[0])
#############################################################
############################ GROUP SIMILAR WORD ##########
#n=0
#for m in similarity_vec:
#    for l in range(len(input)):
##        print(l)192
#        if (m[l] <0.35):
#            return_name[n].append(input[l])
#    n=n+1       
#print(return_name)
#return_name_1=return_name

############################replacement process for vag############
...
#        print(l)
#        if (m[l] <0.35):
#            output_vag[l]=input[n]15
#            print(input[l])
#    n=n+1
#    print(n)
#print('output_vag')
#print(len(output_vag))
#print(output_vag)
#print('input')
#print(len(input))    
#print(input)

########################## return name groups Homogenization  ###############################
#for groupname in return_name_1:
#    if (len(groupname)>1):
#        for i in range(len(groupname)): 
#            groupname[i]=groupname[0]
#print('return_name_1')            
#print(return_name_1)                    
############################ 
...
output_1['اپراتور']=list(itertools.chain(*input0.iloc[:,[6]].values.tolist()))
output_1['ساعت']=list(itertools.chain(*input0.iloc[:,[7]].values.tolist()))
output_1['تاریخ']=list(itertools.chain(*input0.iloc[:,[8]].values.tolist()))
output_1['جنس']=list(itertools.chain(*input0.iloc[:,[9]].values.tolist()))
